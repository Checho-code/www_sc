        ...
        <form name="filtrar" method="POST">
           <div class="table-responsive <?php echo $ver; ?>">
            <table  class="table table-bordered table-striped table-hover table-sm">
                <tbody>
                    <tr>
                    <td><div class="form-group"><label for="desde">Ingrese la fecha inicial *</label>
                    <input type="date" class="form-control" required name="desde" />
                </div></td>

                    <td><div class="form-group"><label for="hasta">Ingrese la fecha final *</label>
...
<div class="col-sm-12">
<h1 class="<?php echo $ver; ?>">Listado de Vendedores </h1>
